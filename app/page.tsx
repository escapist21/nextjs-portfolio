...
export default function Page() {
  return (
    <section className='flex space-x-16'>
      <div className='flex w-1/3 flex-col rounded-2xl border-6 border-emerald-500 py-10 px-4' id='Social Section'>
        ...
        <div className='flex flex-col'>
          ...
          <ul className='flex flex-row mt-6 px-24 justify-evenly'>
            <li>
              <a className="hover:text-emerald-500" rel="noopener noreferrer" target="_blank" href='href="https://www.linkedin.com/in/sourav90/'>
